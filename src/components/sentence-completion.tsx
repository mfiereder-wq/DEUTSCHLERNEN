...
export function SentenceCompletion() {
  ...
  const shuffledOptions = useMemo(() => {
    const options = shuffleOptions(currentExercise.options);

    // Keep the correct answer from appearing in the first slot.
    if (options.length > 1 && options[0] === currentExercise.answer) {
      [options[0], options[1]] = [options[1], options[0]];
    }

    return options;
  }, [currentExercise, shuffleSeed]);
  ...
  }, [selectedOption, currentExercise, completed]);
  ...
  if (gameFinished) {
    ...
    return (
      <div className="mx-auto max-w-2xl">
        <div className="text-center p-8 bg-gradient-to-br from-[#F26B5E]/10 to-[#FF9A8E]/5 rounded-2xl">
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
  ...
  return (
    <Card className="w-full mx-auto max-w-2xl">
      <CardHeader className="space-y-2">
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="text-right">
            <div className="text-sm font-medium text-[#F26B5E]">
              XP: {userXP}
            </div>
        ...
        <div className="w-full bg-muted rounded-full h-2">
          <div 
            className="bg-gradient-to-r from-[#F26B5E] to-[#FF9A8E] h-2 rounded-full transition-all duration-300"
      ...
      <CardContent className="space-y-6">
        <ExerciseImage
          imageKey={currentExercise.id}
          context={`${currentExercise.category} ${currentExercise.sentence}`}
          alt={`Bild zur Satzübung: ${currentExercise.sentence.replace('___', '...')}`}
                        ...
                        showResult
                          ? isCorrect
                            ...
                            : selectedOption && selectedOption !== currentExercise.answer
                              ...
                              : "border-[#F26B5E] bg-[#F26B5E]/10 text-foreground"
                          : selectedOption
                            ? "border-[#F26B5E] bg-[#F26B5E]/10 text-foreground"
              ...
              className={cn(
                ...
                showResult
                  ...
                  : selectedOption === option
                    ? "border-[#F26B5E] bg-[#F26B5E] text-black shadow-md"
          ...
          {!showResult ? (
            <>
              ...
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-[#F26B5E] to-[#FF9A8E] text-black hover:from-[#FF9A8E] hover:to-[#F26B5E]"
              >
                Überprüfen
              </Button>
            </>
            ...
            <>
              ...
              <Button
                onClick={handleNext}
                className="flex-1 bg-gradient-to-r from-[#168C8C] to-[#0F6F70] text-white hover:from-[#42AAA5] hover:to-[#2F8F90]"
              >
