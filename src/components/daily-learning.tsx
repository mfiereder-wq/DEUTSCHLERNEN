    ...
    <div className="relative w-full px-4 sm:px-0 pb-8">
          ...
          >
            ...
            >
              <motion.div
                ...
                className="mb-4"
              >
                <Trophy className="mx-auto h-20 w-20 text-[#F26B5E]" />
              </motion.div>
              ...
              {streakBonus.multiplier > 1 && (
                <p className="mt-2 text-[#F26B5E] font-medium">
      ...
      <div className="mb-8 space-y-6">
        ...
        {newWords.length > 0 && (
          ...
          >
            ...
            <div className="h-2 overflow-hidden rounded-full bg-muted">
              <motion.div 
                className="h-full bg-gradient-to-r from-[#F26B5E] to-[#FF9A8E]"
                initial={{ width: 0 }}
        ...
        <motion.div
          ...
          className="overflow-hidden rounded-2xl border border-[#F26B5E]/20 bg-gradient-to-br from-[#FFFFFF] to-[#E6EFED] p-6"
        >
      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <ScrollArea className="w-full whitespace-nowrap">
            <TabsList className="inline-flex w-full justify-start rounded-xl bg-muted/50 p-1">
              ...
              >
                ...
                {newWords.length > 0 && (
                  <span className="ml-1 rounded-full bg-[#F26B5E]/20 px-2 py-0.5 text-xs text-[#F26B5E]">
                    {newWords.length}
                  </span>
                )}
              </TabsTrigger>
          ...
          <TabsContent value="review" className="mt-6">
            {reviewWords.length > 0 ? (
              <div className="space-y-4">
                <div className="rounded-xl border border-[#F26B5E]/20 bg-[#F26B5E]/5 p-4">
              ...
              <EmptyState
                icon={<Star className="h-16 w-16 text-[#F26B5E]" />}
                title="Gute Arbeit!"
      ...
      {progress < 100 && newWords.length > 0 && (
        ...
        >
          <div className="flex flex-col items-end gap-2">
            {streakBonus.multiplier > 1 && (
              <span className="rounded-full bg-gradient-to-r from-[#F26B5E] to-[#FF9A8E] px-3 py-1 text-xs font-medium text-[#102A43] shadow-lg">
                {streakBonus.message}
              </span>
            )}
            <Button
