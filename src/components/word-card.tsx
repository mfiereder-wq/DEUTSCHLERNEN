    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          'hover:border-[#F26B5E]/50 hover:shadow-warm',
            ...
            {isSupported && (
              <button
                ...
                className={cn(
                  ...
                  'bg-[#F26B5E]/10 text-[#F26B5E] hover:bg-[#F26B5E] hover:text-white',
      ...
      >
        <div className={cn(
          ...
          isLearned 
            ...
            : 'border-[#F26B5E]/20 bg-gradient-to-br from-[#FFFFFF] via-white to-[#F4F7F6]'
        )}>
          {/* Decorative corner */}
          ...
          {/* Content */}
          <div className={cn('text-center', word.isNew && 'pt-2')}>
            <motion.h3 
            ...
            {/* Divider */}
            <div className="mx-auto mb-4 h-px w-16 bg-gradient-to-r from-transparent via-[#F26B5E] to-transparent" />
            ...
            <div className="mb-6 flex flex-wrap items-center justify-center gap-2">
              {word.tags.slice(0, 3).map((tag) => (
                <span 
                  key={tag} 
                  className="rounded-full bg-[#F26B5E]/10 px-3 py-1 text-xs text-[#F26B5E]"
                >
                  {tag}
                </span>
              ))}
              ...
              <div className="flex items-center justify-center gap-3">
                {isSupported && (
                  <Button
                    ...
                    onClick={handlePronounce}
                    disabled={isPlaying}
                    className="rounded-full border-[#F26B5E]/30"
                  >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className={cn(
            ...
            isLearned 
              ...
              : 'border-[#F26B5E]/20 bg-gradient-to-br from-[#FFFFFF] to-[#F4F7F6] hover:border-[#F26B5E]/50'
          )}
        ...
        {/* Back */}
        <div
          className="absolute inset-0 overflow-hidden rounded-xl border-2 border-[#F26B5E]/30 bg-[#102A43] text-white p-4"
          style={{ backfaceVisibility: 'hidden', transform: 'rotateY(180deg)' }}
        >
          <div className="flex h-full flex-col">
            {/* Header */}
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#F26B5E]">{word.category}</span>
              <button 
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center">
              ...
              {word.exampleSentence && (
                <>
                  <div className="w-8 h-px bg-[#F26B5E]/50 my-2" />
            ...
            <div className="flex gap-2">
              ...
              {onLearn && (
                <Button
                  ...
                  className={cn(
                    'flex-1',
                    isLearned ? 'bg-emerald-500' : 'bg-[#F26B5E]'
                  )}
                >
