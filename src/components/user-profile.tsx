...
import { getProgress, PROGRESS_UPDATED_EVENT } from '@/lib/progress-store';
...
export function UserProfile() {
  ...
  useEffect(() => {
    ...
    const refreshProgress = () => {
      ...
      setLearnedWords(progress.completedWords.length);
    };
    refreshProgress();
  ...
  return (
    <div className="space-y-6">
      {/* Profile Header Card */}
      <Card className="bg-gradient-to-br from-[#F26B5E]/10 to-[#FF9A8E]/5 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            >
              <div 
                ...
                className={cn(
                  ...
                  "bg-gradient-to-br from-[#F26B5E] to-[#FF9A8E]",
            ...
            <div className="text-center">
              <div className="inline-flex flex-col items-center p-4 bg-white rounded-2xl shadow-sm">
                <span className="text-3xl font-bold text-[#F26B5E]">{current.id}</span>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Card className="bg-muted/50">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-[#F26B5E]">{userXP}</div>
        ...
        <Card className="bg-muted/50">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-[#168C8C]">{completedLevels}</div>
            <p className="text-xs text-muted-foreground flex items-center justify-center gap-1">
        ...
        <Card className="bg-muted/50">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-[#F26B5E]">{daysSinceJoin}</div>
            <p className="text-xs text-muted-foreground flex items-center justify-center gap-1">
        ...
        <Card className="bg-muted/50">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-[#168C8C]">{learnedWords}</div>
            <p className="text-xs text-muted-foreground flex items-center justify-center gap-1">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg flex items-center gap-2">
            <Target className="h-5 w-5 text-[#F26B5E]" />
        ...
        <CardContent>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              <span>Vokabeln</span>
              <span className="text-[#F26B5E] font-medium">{current.vocabularyCount} Wörter</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span>Satz-Übungen</span>
              <span className="text-[#F26B5E] font-medium">{current.sentenceCount} Sätze</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span>Quiz-Fragen</span>
              <span className="text-[#F26B5E] font-medium">{current.quizCount} Quizze</span>
            </div>
          </div>
