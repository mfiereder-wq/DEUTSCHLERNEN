        ...
        <CardContent className="pt-6 text-center">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="p-4 bg-muted/50 rounded-xl">
              <div className="text-2xl font-bold text-[#F26B5E]">{score}</div>
              <div className="text-xs text-muted-foreground">Punkte</div>
            </div>
            <div className="p-4 bg-muted/50 rounded-xl">
              <div className="text-2xl font-bold text-[#F26B5E]">{maxStreak}</div>
              <div className="text-xs text-muted-foreground">Beste Serie</div>
            </div>
            <div className="p-4 bg-muted/50 rounded-xl">
              <div className="text-2xl font-bold text-[#168C8C]">{completed.length}/{QUIZ_QUESTIONS.length}</div>
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-[#F26B5E] to-[#FF9A8E] text-black hover:from-[#FF9A8E] hover:to-[#E5C58C]"
          >
    ...
    <Card className="w-full mx-auto max-w-2xl">
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div>
            <CardTitle className="flex items-center gap-2">
              <Zap className="h-5 w-5 text-[#F26B5E]" />
              Quiz Challenge
            </CardTitle>
            <CardDescription>
              Teste dein Wissen!
          ...
          <div className="flex items-center gap-3">
            ...
            <Badge variant="outline" className="bg-[#F26B5E]/10">
              🔥 {streak}
            </Badge>
          </div>
        </div>
      ...
      <CardContent className="space-y-6">
        <ExerciseImage
          ...
          context={`${currentQuestion.category} ${currentQuestion.question}`}
          alt={`Bild zur Quizfrage: ${currentQuestion.question}`}
