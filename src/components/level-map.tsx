...
export function LevelMap({ currentXP, onSelectLevel }: LevelMapProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-[#F26B5E]/10 to-[#FF9A8E]/5">
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-3xl font-bold text-[#F26B5E]">{currentXP}</div>
            ...
            >
              <Card 
                className={cn(
                  ...
                  isCurrent && "ring-2 ring-[#F26B5E] ring-offset-2",
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {isCurrent && (
                          <Badge className="bg-[#F26B5E] text-black text-xs">
                            Aktuell
                          </Badge>
                        )}
                      </div>
                    ...
                    <div className="text-right">
                      {!isUnlocked ? (
                        <div className="text-xs text-muted-foreground">
                          <Zap className="h-4 w-4 mx-auto mb-1 text-[#F26B5E]" />
                          {level.requiredXP} XP
                        </div>
                      ) : isCompleted ? (
      ...
      <Card className="bg-muted/50">
        <CardContent className="p-4">
          <h4 className="font-medium mb-3 flex items-center gap-2">
            <Star className="h-4 w-4 text-[#F26B5E]" />
            XP verdienen
          </h4>
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="flex justify-between">
              <span className="text-muted-foreground">Wort gelernt</span>
              <span className="font-medium text-[#F26B5E]">+{XP_REWARDS.WORD_LEARNED}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Satz richtig</span>
              <span className="font-medium text-[#F26B5E]">+{XP_REWARDS.SENTENCE_CORRECT}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Quiz richtig</span>
              <span className="font-medium text-[#F26B5E]">+{XP_REWARDS.QUIZ_CORRECT}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Level abschließen</span>
              <span className="font-medium text-[#F26B5E]">+{XP_REWARDS.LEVEL_COMPLETE}</span>
            </div>
          </div>
        </CardContent>
      </Card>
